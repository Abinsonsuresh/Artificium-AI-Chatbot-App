    ...
    return (
        <>
            <div className="flex">
                ...
                <div className=" w-[312px] bg-[#0f1112] p-2 rounded-xl  h-full min-h-screen md:min-h-full gap-1 hidden md:flex flex-col justify-between  overflow-y-scroll  overflow-x-hidden scroll  scroll-smooth hide-scrollbar" >
            ...
            <div className={!nav ? `w-[312px] bg-[#0f1112] p-2 rounded-b-xl fixed right-[-100%] top-0 h-full min-h-screen md:min-h-full gap-1 hidden ` : `w-[312px] fixed left-0 top-0 bg-[#0f1112] z-50 p-2 rounded-b-xl  min-h-screen md:min-h-full gap-1   overflow-y-scroll  overflow-x-hidden scroll  scroll-smooth hide-scrollbar`}>
                    <div className='flex flex-col gap-1'>
                        {/* GROUP SECTION */}
                        <div className='GROUP flex flex-row justify-between items-center p-[24px] rounded-t-xl bg-[#0D0F10] '>
                            <div className='flex flex-row justify-center items-center gap-5'>
                    ...
                    <div className={!nav ?  ` hidden ` : `w-12 h-12 fixed top-0 right-0 bg-[#0f1112] rounded-r-lg flex items-center justify-center md:hidden`}>
