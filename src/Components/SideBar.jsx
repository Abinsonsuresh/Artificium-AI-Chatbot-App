    ...
    return (
        <>
            <div className="flex">
                ...
                <div className='w-[312px] bg-[#0f1112] p-2 rounded-b-xl  h-full min-h-screen md:min-h-full gap-1 hidden md:flex flex-col justify-between  overflow-y-scroll  overflow-x-hidden scroll  scroll-smooth'>
