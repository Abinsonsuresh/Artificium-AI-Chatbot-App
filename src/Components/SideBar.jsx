...
const SideBar = () => {
    return (
        <>
            ...
            <div className='w-[312px] bg-[#0f1112] p-2 rounded-xl  h-full min-h-[650px]  gap-1 hidden md:flex flex-col justify-between  overflow-y-scroll  overflow-x-hidden scroll  scroll-smooth'>
